...
<div class="body d-flex py-3">
    <div class="container-xxl">
        ...
        <form action="{{route('admin.orders.new')}}" method="GET">
        ...
        <br>
        <a href="{{route('admin.order.download-new-csv')}}?{{($_SERVER['QUERY_STRING'])}}"><button class="btn btn-sm btn-primary" type="button"> CSV </button></a>
        <br>
        <br>
