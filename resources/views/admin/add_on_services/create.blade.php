        ...
        <div class="row g-3 mb-3">
            <div class="col-lg-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.add_on_services.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <!-- <div class="row g-3 align-items-center"> -->
                            <div class="row">
                                <div class="col-md-6"> 
                                    <label class="form-label">Service Name</label>                                    
                                    {!! Form::text('title', '', array('placeholder' => 'Service Name','class' => 'form-control')) !!}
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Price</label>
                                    {!! Form::number('price', '', array('placeholder' => 'Price','class' => 'form-control')) !!}
                                </div>
                                <div class="col-md-6">
